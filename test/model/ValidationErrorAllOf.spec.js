...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkSmartThingDirectory.ValidationErrorAllOf();
  });
  ...
  describe('ValidationErrorAllOf', function() {
    it('should create an instance of ValidationErrorAllOf', function() {
      // uncomment below and update the code to test ValidationErrorAllOf
      //var instance = new LinkSmartThingDirectory.ValidationErrorAllOf();
      //expect(instance).to.be.a(LinkSmartThingDirectory.ValidationErrorAllOf);
    });
