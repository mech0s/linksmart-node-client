...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkSmartThingDirectory.ValidationResult();
  });
  ...
  describe('ValidationResult', function() {
    it('should create an instance of ValidationResult', function() {
      ...
      //var instance = new LinkSmartThingDirectory.ValidationResult();
      //expect(instance).to.be.a(LinkSmartThingDirectory.ValidationResult);
    });
