...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkSmartThingDirectory.ValidationError();
  });
  ...
  describe('ValidationError', function() {
    it('should create an instance of ValidationError', function() {
      ...
      //var instance = new LinkSmartThingDirectory.ValidationError();
      //expect(instance).to.be.a(LinkSmartThingDirectory.ValidationError);
    });
