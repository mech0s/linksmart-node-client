...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkSmartThingDirectory.ValidationApi();
  });
  ...
  describe('ValidationApi', function() {
    describe('validationGet', function() {
      it('should call validationGet successfully', function(done) {
        //uncomment below and update the code to test validationGet
        //instance.validationGet(function(error) {
